(function () {
  ...
  async function saveAssignment(event) {
    ...
    const updated = { id, classId: activeClassId, title, topic: topicData.topic, chapter: topicData.chapter, due, createdAt: existing?.createdAt || new Date().toISOString(), sampleType: file?.type || existing?.sampleType || "", sampleName: file?.name || existing?.sampleName || "" };
